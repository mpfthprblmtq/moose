...
public class SongController {
    ...
    /**
     * Utility method that generates a list of songs given an array of rows
     * @param rows the rows to get the songs from
     * @return a list of Song objects
     */
    public List<Song> getSongsFromRows(int[] rows) {
    ...
    public void autoTagFiles(int[] selectedRows) {
        List<Song> songsToProcess = getSongsFromRows(selectedRows);

        // format the filenames first
        filenameFormatterService.formatFilenames(songsToProcess);

        // actually do the autotagging
        autoTaggingService.autoTag(songsToProcess);
    }

    /**
     * Function that only formats the filenames
     * @param selectedRows the rows selected on the table
     */
    ...
    /**
     * Function that only sets the track and disk numbers
     * @param selectedRows the rows selected on the table
     */
    public void autoAddTrackAndDiskNumbers(int[] selectedRows) {
        List<Song> songsToProcess = getSongsFromRows(selectedRows);
        autoTaggingService.autoAddTrackAndDiskNumbers(songsToProcess);
    }
    ...
    /**
     * Function that only automatically adds album artwork
     * @param selectedRows the rows selected on the table
     */
    public void autoAddCoverArt(int[] selectedRows) {
        List<Song> songsToProcess = getSongsFromRows(selectedRows);
        autoTaggingService.autoAddCoverArt(songsToProcess);
    }
