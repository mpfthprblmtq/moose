...
//        ViewUtils.setColumnWidth(table, 11, 20);    // index
    ...
    public void updateTableFromMultPanelFields(int[] selectedRows) {
        ...
        // create a song from the values in the mult panel
        Song song = new Song();
